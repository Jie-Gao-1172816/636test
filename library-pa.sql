--  ------------------------------------------------------------  --
--  CREATE OR UPDATE THE LIBRARY DEMO DATABASE ON PYTHONANYWHERE  --
--  ------------------------------------------------------------  --

--  * * IMPORTANT * *:  You must create a database called 'library' in the MySQL console
--                      before running this query.
--                      (We can't create a new database from a query script in PA)
...
INSERT INTO loans VALUES(53674, 2,    659,  @mid_semester_date - INTERVAL 36 DAY,  @mid_semester_date - INTERVAL 30 DAY);  -- 2025-07-10 .. 2025-07-16
INSERT INTO loans VALUES(53675, 372,  533,  @mid_semester_date - INTERVAL 36 DAY,  NULL);         -- 2025-07-10
...
INSERT INTO loans VALUES(53679, 93,   7523, @mid_semester_date - INTERVAL 14 DAY,  NULL);         -- 2025-08-01
